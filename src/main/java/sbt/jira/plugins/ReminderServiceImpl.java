...
public class ReminderServiceImpl implements ReminderService 
{
	...
	public ReminderServiceImpl(ActiveObjects ao, IssueManager issueManager, UserManager userManager, ApplicationProperties applicationProperties, JiraAuthenticationContext authenticationContext){
		this.ao = ao;
